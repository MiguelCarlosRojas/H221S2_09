const url = "http://54.81.15.104:3006/api/contactanos"; //Cambiar por ip del servidor en caso la db este en otra maquina. (54.81.15.104/)
...
if (nombre.value == "" || correo.value == "" || asunto.value == "" || descripcion.value == "") {
    ...
    function mostrarMensajeCorrecto() {
        ...
        setTimeout(function () { mensaje.className = mensaje.className.replace("show-correcto",
        ""); }, 3000);
        }
        ...
        setTimeout(function () { mensaje.className = mensaje.className.replace("show-error", "");
        }, 3000);
        }
